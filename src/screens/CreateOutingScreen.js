...
import { View, Text, StyleSheet, TouchableOpacity, TextInput, Switch, ScrollView, Image, Header } from 'react-native';
      ...
      <ScrollView>
        ...
        <View style={{justifyContent: "space-evenly"}}>
            ...
            <Button
                ...
                style={{ color: "white", backgroundColor: "#EEF1FF"}}
                //buttonStyle={styles.buttonStyle}
            />
          {/* ============== SCROLLABLE VIEW WHEN KEYBOARD IS ACTIVE ============ */}
          <KeyboardAwareScrollView>

            <Text style={{ fontSize: 17, padding: 5, marginTop: 10}}
                  > Add Location:  </Text>
