...
const test = [  //mill
  { id: "first", uri: require('../images/mill1.png')},
  { id: "second", uri: require('../images/mill2.png') },
  { id: "third", uri: require('../images/mill3.png')},
  { id: "fourth", uri: require('../images/mill4.png')}
]
const SCREEN_WIDTH = Dimensions.get('window').width;

class ViewIreland extends React.Component {
  state = {
