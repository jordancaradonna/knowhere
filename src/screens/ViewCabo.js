...
const test = [
  { id: "first", uri: require('../images/cabo1.png')},
  { id: "second", uri: require('../images/cabo2.png') },
  { id: "third", uri: require('../images/cabo3.png')},
  //{ id: "fourth", uri: require('../images/mill4.png')}
]
const SCREEN_WIDTH = Dimensions.get('window').width;

class ViewCabo extends React.Component {
  state = {
